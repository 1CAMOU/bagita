...
<body class="bg-gray-50">
    <div class="bg-gradient-to-tr from-primary-light to-primary-dark w-full shadow-md">
        <nav class="p-6 flex flex-col md:flex-row items-center">
            ...
            <div class="md:ml-auto mt-8 md:mt-0 flex flex-col md:flex-row items-center">
                ...
                <a class="bg-gray-50 hover:bg-gray-100 transition-colors px-6 pt-2 pb-1 rounded-md text-secondary font-semibold" href="#newsletter">SUBSCRIBE</a>
            </div>
        </nav>
    </div>
