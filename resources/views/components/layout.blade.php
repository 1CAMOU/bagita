...
>>>>>>> 88f7372f9e363f4bcbd328c7ac9f718749c319d3
    ...
    <div class="m-6 bg-gray-100 py-14 rounded-md flex justify-center items-center w-auto mb-12 md:mb-6">
        <div class="flex flex-col justify-center items-center w-full">
            ...
            <form class="w-11/12 md:w-96 h-auto md:h-9 relative mt-6 flex flex-col md:flex-row bg-transparent md:bg-gray-200">
                ...
                <input class="w-full h-full pt-2 pb-1 pl-10 pr-4 bg-gray-200 md:bg-transparent focus:outline-none" type="email" placeholder="Your email address">
                <button class="bg-primary rounded-md px-4 pt-4 pb-3 mt-4 md:mt-0 md:py-0 md:pt-1 md:pb-0 font-semibold text-secondary align-middle">SUBSCRIBE</button>
            </form>
        </div>
    </div>
