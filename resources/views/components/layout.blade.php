...
<body class="bg-gray-50">
    <div class="bg-gradient-to-tr from-primary-light to-primary-dark w-full pb-12 shadow-md">
        <nav class="p-6 flex items-center">
            ...
            <ul class="flex ml-24">
                <li class="text-secondary font-medium mr-6"><a href="">Home</a></li>
                <li class="text-secondary font-medium mr-6"><a href="">About</a></li>
                <li class="text-secondary font-medium mr-6"><a href="">Collection</a></li>
                <li class="text-secondary font-medium mr-6"><a href="">Author</a></li>
            </ul>
        
            <button class="ml-auto bg-gray-50 px-6 pt-2 pb-1 rounded-md text-secondary font-semibold" href="">SUBSCRIBE</button>
        </nav>
    ...
    <div class="m-6 bg-gray-100 w-auto py-14 rounded-md flex justify-center items-center">
        <div class="flex flex-col justify-center items-center">
            ...
            <h3 class="text-2xl text-secondary font-medium">Stay in touch with the latest posts</h3>
            <h4 class="text-lg text-secondary">Promise to keep the inbox clean. No spam.</h4>

            <form class="w-96 h-9 relative mt-6 flex bg-gray-200">
                ...
                <input class="w-full h-full pt-2 pb-1 pl-10 pr-4 bg-transparent focus:outline-none" type="email" placeholder="Your email address">
                <button class="bg-primary rounded-md px-4 pt-1 font-semibold text-secondary">SUBSCRIBE</button>
            </form>
        </div>
    </div>
</body>
