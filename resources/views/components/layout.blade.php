...
<body class="bg-gray-50">
    ...
    <div class="m-6 bg-gray-100 py-14 rounded-md flex justify-center items-center w-auto">
        <div class="flex flex-col justify-center items-center w-full">
            ...
            <form class="w-full md:w-96 h-9 relative mt-6 flex flex-col md:flex-row bg-gray-200">
